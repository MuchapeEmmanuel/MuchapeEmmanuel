...
def contact():
    mess._show(title='Contact us', message="Please contact us on : '2017012997@student.unza.zm, 2017001325@student.unza.zm, 2017012911@student.unza.zm,  2017012956@student.unza.zm, 2017012968@student.unza.zm'")
###################################################################################
...
window.configure(background='#00c3ff')

frame1 = tk.Frame(window, bg="#ff0033")
frame1.place(relx=0.11, rely=0.17, relwidth=0.39, relheight=0.80)

frame2 = tk.Frame(window, bg="#ff0033")
frame2.place(relx=0.51, rely=0.17, relwidth=0.38, relheight=0.80)

message3 = tk.Label(window, text="UNIVERSITY OF ZAMBIA FACE RECOGNITION ATTENDANCE SYSTEM" ,fg="green",bg="#262522" ,width=60 ,height=1,font=('times', 30, ' bold '))
...
datef = tk.Label(frame4, text = day+"-"+mont[month]+"-"+year+"  |  ", fg="orange",bg="#020302" ,width=55 ,height=1,font=('times', 22, ' bold '))
...
message1 = tk.Label(frame2, text="1)Take Images  >>>  2)Save Profile" ,bg="#00aeff" ,fg="black"  ,width=39 ,height=1, activebackground = "green" ,font=('times', 15, ' bold '))
message1.place(x=7, y=230)

message = tk.Label(frame2, text="" ,bg="#00aeff" ,fg="black"  ,width=39,height=1, activebackground = "green" ,font=('times', 16, ' bold '))
...
trainImg = tk.Button(frame2, text="Save Profile", command=psw ,fg="white"  ,bg="green"  ,width=34  ,height=1, activebackground = "white" ,font=('times', 15, ' bold '))
